 ...
 * @author CJ
 */
public class ITransactions extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ITransactions.class.getName());

    /**
     * Creates new form ITransactions
     */
    ...
    private JPanel createHeader(){
        ...
        JLabel subtitleLabel = new JLabel("Historique complet des transactions bancaires");
        ...
        searchField.setText("Rechercher une transaction...");
        ...
        searchField.addFocusListener(new FocusAdapter(){
            ...
            public void focusGained(FocusEvent e){
                if(searchField.getText().equals("Rechercher une transaction...")){
                    searchField.setText("");
    ...
    private JTable createTransactionTable(){
        String[] columns = {"ID", "Montant", "Devise", "Date/Heure", "Statut", "Type", "Motif", "N° Compte"};
        ...
        int[] widths = {60, 120, 80, 150, 100, 100, 250, 150};
        ...
        table.getColumnModel().getColumn(4).setCellRenderer(new DefaultTableCellRenderer(){
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column){
                ...
                if (statut.contains("validé") || statut.contains("valide") || statut.contains("réussi")) {
                    badge.setBackground(new Color(212, 237, 218));
                    badge.setForeground(new Color(21, 87, 36));
                } else if (statut.contains("échoué") || statut.contains("echec") || statut.contains("refusé")) {
    ...
    private void loadTransactions(){
        ...
        try{
            ...
            String sql = "SELECT idTrans, montantTrans, devTrans, heureTrans, statut, typeTrans, motifTrans, numCompte " +
                     "FROM transaction ORDER BY heureTrans DESC";
            ...
            while(rs.next()){
                count++;
                int id = rs.getInt("idTrans");
                double montant = rs.getDouble("montantTrans");
                String devise = rs.getString("devTrans");  
                Timestamp heure = rs.getTimestamp("heureTrans");
                String statut = rs.getString("statut");
                String type = rs.getString("typeTrans");
                String motif = rs.getString("motifTrans");
                String numCompte = rs.getString("numCompte");
                
                SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
                String dateFormatee = sdf.format(heure);
    ...
    private void updateTransactionCount(int count){
        if(countBadge != null){
            String text = count + "transaction" + (count > 1 ? "s" : "");
    ...
    private void searchTransactions(){
        ...
        if (searchText.isEmpty() || searchText.equals("rechercher une transaction...")) {
            loadTransactions();
            return;
        }
        ...
        try{
            ...
            String sql = "SELECT idTrans, montantTrans, devTrans, heureTrans, statut, typeTrans, motifTrans, numCompte " +
                     "FROM transaction WHERE LOWER(statut) LIKE ? OR LOWER(typeTrans) LIKE ? " +
                     "OR LOWER(motifTrans) LIKE ? OR numCompte LIKE ? OR CAST(idTrans AS CHAR) LIKE ? " +
                     "OR LOWER(devTrans) LIKE ? " +  
                     "ORDER BY heureTrans DESC";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ITransactions().setVisible(true));
    }
