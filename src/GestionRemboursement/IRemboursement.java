 ...
 * @author CJ
 */
public class IRemboursement extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(IRemboursement.class.getName());

    /**
     * Creates new form IRemboursement
     */
    public IRemboursement() {
        initUI();
    ...
    private JPanel createHeader(){
        ...
        JLabel titleLabel = new JLabel("Gestion des Remboursement");
        titleLabel.setFont(new Font("Century Gothic", Font.BOLD, 32));
        titleLabel.setForeground(new Color(28, 30, 33));
        titleLabel.setAlignmentX(Component.LEFT_ALIGNMENT);
        
        JLabel subtitleLabel = new JLabel("Historique complet des rembousements des clients");
        ...
        searchField.setText("Rechercher un remboursement...");
    ...
    private JTable createPretTable(){
        String[] columns = {"ID", "Montant", "Devise", "Date", "Pret"};
    ...
    private void loadRemb(){
        ...
        try{
            ...
            String sql = "SELECT idRemb, montRemb, dateRemb, idPret, devRemb FROM remboursement ORDER BY dateRemb DESC";
            ...
            while(rs.next()){
                count++;
                int id = rs.getInt("idRemb");
                double montant = rs.getDouble("montRemb");
                Timestamp dateRemb = rs.getTimestamp("dateRemb");
                int idPret = rs.getInt("idPret");
                String devise = rs.getString("devRemb");
                
                SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
                String dateFormatee = sdf.format(dateRemb);
    ...
    private void updateRembCount(int count){
        if(countBadge != null){
            String text = count + "remboursement" + (count > 1 ? "s" : "");
    ...
    private void searchRemb(){
        String searchText = searchField.getText().toLowerCase().trim();
        
        if (searchText.isEmpty() || searchText.equals("rechercher un remboursement...")) {
            loadRemb();
            return;
        }
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this,
            "Erreur lors du chargement des remboursement: " + e.getMessage(),
            "Erreur",
            JOptionPane.ERROR_MESSAGE);
        }finally{
            try{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new IRemboursement().setVisible(true));
    }
